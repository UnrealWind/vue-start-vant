...
<template>
  <van-container :status="status">
      ...
      <div class="wp">
        <div class="nav_ul fix">
          <div class="li l">
            <div class="wrap">
              <div class="top fix">
                <div class="topl l"> ¥ <span> 20 </span>  </div>
                <div class="topr r">
                  <div class="title"> 满99元可用 </div>
                  <p> 立即领取 </p>
                </div>
              </div>
              <div class="bot_title">瓷妆优惠券满99减20  </div>
            </div>
          </div>
          <div class="li r">
            <div class="wrap">
    ...
    <div class="nav_box3 dan_wrap">
      <div class="wp">
        <div class="title">爆款推荐口碑精选</div>
      </div>
    </div>

    <div class="nav_box4 dan_wrap">
      <div class="wp">
        <div v-for="(vip,index) in vipData" :key="`${vip.type}-${index}`" class="navdan_box4">
          <commodity
            :type="vip.type"
            :image="vip.image"
...
<style lang='scss' scoped>
  ...
  .dan_wrap{ .wp{ width: 95%; margin: 0 auto;  } }
  .van-swipe {
    img {
      display: block;
      width:100%;
  ...
  .nav_box{
    ...
    .top{
      ...
      border-bottom: 1px dashed #dcc38d;
      padding-bottom: 10px;
    }
    .bot_title{
      padding: 5px 10px;
  ...
  .nav_box2{
    background: #ffe3e7;
    .nav_ul{ padding-top: 8px; display: block;
  ...
  .nav_box4{ background: #ffe3e7; padding-bottom: 1px; padding-top: 10px; }
  .navdan_box4{
    background: #fff;
    border-radius: 20px;
    margin-bottom: 20px;
