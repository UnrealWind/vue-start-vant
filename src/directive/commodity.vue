<template>
  <div class="container">
        ...
        <van-col span="16">
          <div class="info-box">
            ...
            <span class="button-concentrate" @click="btnCallBack">
              <van-icon :name="'arrow'" color="#fff" size="13px"></van-icon>
            </span>
          </div>
        </van-col>
      </van-row>
    ...
    <div v-if="type === 'list-index'" class="list-index-box">
      <div class="img-box">
        <img :src="image">
        <van-button type="default" size="small" round @click="btnCallBack">抢购</van-button>
        <img src="" title="今日爆款">
      </div>
      <div class="info-box">
        <van-row>
          ...
          <van-col span="8">
            ...
            <span class="priceDiscribe">
              <span v-if="indexPriceDiscribe.type === '已告罄' || indexPriceDiscribe.type === '即将告罄'" class="capsuleSingle">{{ indexPriceDiscribe.type }}</span>
              <span v-if="indexPriceDiscribe.type === '抢购中'" class="capsule">&nbsp;</span>
              <span v-if="indexPriceDiscribe.type === '抢购中'" class="capsuleFont">已抢{{ indexPriceDiscribe.num }}件  <i>{{ indexPriceDiscribe.percent }}%</i></span>
              <span v-if="indexPriceDiscribe.type === '抢购中'" class="capsuleBg" :style="customPriceDiscribe">&nbsp;</span>
            </span>
          </van-col>
        </van-row>
      </div>
    ...
    <div v-if="type === 'list-vip'" class="list-vip-box">
      ...
      <div class="info-box">
        <van-row>
          ...
          <van-col span="12" class="price-left">
            <van-button plain type="danger" size="mini">特卖</van-button>
            <span class="price">
              <span class="current">
          ...
          <van-col span="12" class="price-right">
            <van-button type="danger" size="small" round @click="btnCallBack">立即抢购</van-button>
            <span v-if="vipPriceDiscribe" class="priceDiscribe">
              ...
              <span v-if="vipPriceDiscribe.type === '抢购中'" class="capsule">&nbsp;</span>
              <span v-if="vipPriceDiscribe.type === '抢购中'" class="capsuleFont">已抢{{ vipPriceDiscribe.num }}件  <i>{{ vipPriceDiscribe.percent }}%</i></span>
              <span v-if="vipPriceDiscribe.type === '抢购中'" class="capsuleBg" :style="customPriceDiscribe">&nbsp;</span>
            </span>
          </van-col>
        </van-row>
      </div>
      ...
      <van-row>
        ...
        <van-col span="16">
          <div class="info-box">
            ...
            <van-button class="f-right" type="danger" size="small" round @click="btnCallBack">去抢购&nbsp;>&nbsp;</van-button>
          </div>
        </van-col>
        <van-col span="24">
          <div class="evaluate">
    ...
    <div v-if="type === 'list-rebate'" class="list-rebate-box">
      <van-row>
        ...
        <van-col class="img-box" span="12">
          <img :src="image">
          <van-button class="" type="danger" size="small" round @click="btnCallBack">购买</van-button>
        </van-col>
      </van-row>
    </div>
  </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            customPriceDiscribe() {
              let precent
                this.indexPriceDiscribe ? precent = this.indexPriceDiscribe.percent : precent = this.vipPriceDiscribe.percent
              return {
                  width: precent + '%'
              }
            }
